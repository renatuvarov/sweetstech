...
class GalleriesController extends Controller
{
    ...
    public function store(CreateRequest $request, ImageManager $manager)
    {
    ...
    public function update(UpdateRequest $request, Gallery $gallery, ImageManager $manager)
    {
        $gallery->update([
            'name' => $request->input('name'),
    ...
    public function destroy(Gallery $gallery, ImageManager $manager)
    {
