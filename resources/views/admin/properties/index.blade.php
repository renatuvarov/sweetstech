        ...
        @if(! empty($properties) && $properties->count() > 0)
            <table class="table table-bordered table-hover mt-5">
                ...
                <tr>
                    ...
                    <th scope="col">Ед. изм. (eng)</th>
                    <th scope="col">Ед. изм. (ru)</th>
                ...
                @foreach($properties as $property)
                    <tr>
                        ...
                        <td class="align-middle">{{$property->name_en}}</td>
                        <td class="align-middle">{{$property->name_ru}}</td>
                        <td class="align-middle">{{$property->measure_en ?? '-'}}</td>
                        <td class="align-middle">{{$property->measure_ru ?? '-'}}</td>
