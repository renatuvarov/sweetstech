...
@section('content')
    <div class="container text-center">
        <h2 class="h2 mb-5 display-4">Новый производитель</h2>
        <form class="text-left w-50 m-auto" method="post" action="{{ route('admin.manufacturer.store') }}" enctype="multipart/form-data">
            @csrf
