...
@section('description')
    <meta content="последние выставки" name="description">
@endsection
        ...
        <div class="intro-content-news  display-table">
            <div class="table-cell">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <h1 class="equipment-title equipment-title-all mb-4">{{ $category->name_ru }}</h1>
                            <ol class="breadcrumb">
                        ...
                        <div class="col-md-12 card-news">
                            <div class="row">
                                <div class="col-md-7 text-news">
                                    ...
                                    <a href="{{ route('ru.user.exhibitions.news.show', ['slug' => $post->slug]) }}" class="news-button" aria-label="Читать полностью">
                                        <span>Читать...</span>
                                    </a>
                                </div>
                ...
                <div class="col-md-12 card-news text-center d-flex justify-content-center align-items-center" style="min-height: 300px">
                    <div class="row">
                        <div class="col-md-12 text-news m-0" style="font-size: 35px;">
                            <p class="align-self-center">Выставок не найдено.</p>
                        </div>
                    </div>
                </div>
            @endif
