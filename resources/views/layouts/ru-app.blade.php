        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul itemscope itemtype="https://www.schema.org/SiteNavigationElement" class="navbar-nav right">
                <li itemprop="name" class="nav-item">
                    <a  itemprop="url" class="nav-link" href="{{ route('ru.main') }}">Главная</a>
                </li>
                <li itemprop="name" class="nav-item">
                    <a itemprop="url" class="nav-link" href="{{ route('ru.user.catalog.index') }}">Оборудование</a>
                </li>
                <li itemprop="name" class="nav-item">
                    <a itemprop="url" class="nav-link" href="{{ route('ru.user.blog.news.index') }}">Новости</a>
                </li>
                <li itemprop="name" class="nav-item">
                    <a itemprop="url" class="nav-link" href="{{ route('ru.user.exhibitions.news.index') }}">Выставки</a>
                </li>
                <li class="nav-item">
